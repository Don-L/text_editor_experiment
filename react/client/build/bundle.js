...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextEditor = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(TextEditor, { textURL: 'http://localhost:3000/text'
	...
	var TextEditor = React.createClass({
	  ...
	  render: function render() {
	    if (this.state.editing === false) {
	      ...
	      return React.createElement("div", { dangerouslySetInnerHTML: markUp(), onDoubleClick: this.onDoubleClick });
	    } else {
	  ...
	  loadResourcesFromServer: function loadResourcesFromServer() {
	    var textURL = this.props.textURL;
	  ...
	  toggleEditing: function toggleEditing() {
	    if (this.state.editing === false) {
	      ...
	      var url = this.props.textURL;
	      var request = new XMLHttpRequest();
	      var params = { "the_text": "" + this.state.text };
	  ...
	  updateDisplayedText: function updateDisplayedText(e) {
